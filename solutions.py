...
def is_sweltering():
    ...
    current_temperature = int(input("Enter the current temperature in Fahrenheit: "))
...
def is_warm():
    ...
    """
    # write your code for this function below this line.
    temperature = int(input("Enter the current temperature in Fahrenheit: "))
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    user_response = input("Is it humid today (yes/no)? ").strip().lower()
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    forecast = input("What is the weather forecast for today? ").lower()
    if "rain" in forecast or "snow" in forecast or "sleet" in forecast:
        return True
    else:
        return False
